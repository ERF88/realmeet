...
public class RoomValidatorUnitTest extends BaseUnitTest {
    ...
    void testValidateWhenRoomNameIsMissing() {
        ...
        assertEquals(
            new ValidationError(ROOM_NAME, ROOM_NAME.concat(MISSING)),
    ...
    void testValidateWhenRoomNameExceedsLength() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErrors());
        assertEquals(
            new ValidationError(ROOM_NAME, ROOM_NAME.concat(EXCEEDS_MAX_LENGTH)),
            exception.getValidationErrors().getError(0)
        );
    }
    ...
    void testValidateWhenRoomSeatsAreMissing() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErrors());
        assertEquals(
            new ValidationError(ROOM_SEATS, ROOM_SEATS.concat(MISSING)),
            exception.getValidationErrors().getError(0)
        );
    }
    ...
    void testValidateWhenRoomSeatsAreLessThanMinValue() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErrors());
        assertEquals(
            new ValidationError(ROOM_SEATS, ROOM_SEATS.concat(BELOW_MIN_VALUE)),
            exception.getValidationErrors().getError(0)
        );
    }
    ...
    void testValidateWhenRoomSeatsAreGreaterThanMaxValue() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErrors());
        assertEquals(
            new ValidationError(ROOM_SEATS, ROOM_SEATS.concat(EXCEEDS_MAX_VALUE)),
            exception.getValidationErrors().getError(0)
        );
    }
    ...
    void testValidateWhenRoomNameDuplicate() {
        ...
        assertEquals(1, exception.getValidationErrors().getNumberOfErrors());
        assertEquals(
            new ValidationError(ROOM_NAME, ROOM_NAME.concat(DUPLICATE)),
            exception.getValidationErrors().getError(0)
        );
    }
}
